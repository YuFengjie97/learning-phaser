...
import bgDay from '@/assets/flappyBird/sprites/background-day.png?url'
import ground from '@/assets/flappyBird/sprites/ground-sprite.png?url'

import startMenu from '@/assets/flappyBird/sprites/message-initial.png?url'
import gameOver from '@/assets/flappyBird/sprites/gameover.png?url'
import restart from '@/assets/flappyBird/sprites/restart-button.png?url'

import birdRed from '@/assets/flappyBird/sprites/bird-red-sprite.png?url'

import pipeGreenTop from '@/assets/flappyBird/sprites/pipe-green-top.png?url'
import pipeGreenBottom from '@/assets/flappyBird/sprites/pipe-green-bottom.png?url'

import num0 from '@/assets/flappyBird/sprites/number0.png?url'
import num1 from '@/assets/flappyBird/sprites/number1.png?url'
import num2 from '@/assets/flappyBird/sprites/number2.png?url'
import num3 from '@/assets/flappyBird/sprites/number3.png?url'
import num4 from '@/assets/flappyBird/sprites/number4.png?url'
import num5 from '@/assets/flappyBird/sprites/number5.png?url'
import num6 from '@/assets/flappyBird/sprites/number6.png?url'
import num7 from '@/assets/flappyBird/sprites/number7.png?url'
